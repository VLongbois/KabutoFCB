class Timer extends HTMLElement {
    ...
    private initializeComponent() {
        // Récupération du temps depuis l'attribut `time`
        const timeAttr = this.getAttribute('time');
        this.duration = timeAttr ? parseInt(timeAttr, 10) : 60;
        this.timeLeft = this.duration;

        this.timerElement = this.shadowRoot!.getElementById('time')!;
        this.toggleButton = this.shadowRoot!.getElementById('toggle') as HTMLButtonElement;
...
customElements.define('kfcb-timer', Timer);
